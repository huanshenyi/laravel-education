...
<script>
    export default {
        ...
        //オススメ
        mounted(){
          this.axios.get('http://laravelvideo.com/api/commendLesson/4').then((response)=>{
              this.commendLesson = response.data.data;
          })

            //人気
          this.axios.get('http://laravelvideo.com/api/hotLesson/3').then((response)=>{
        ...
        data(){
            return{
                ...
                hotLesson:[],
                slides:[
                    {id:1,path:'static/images/1.png'},
                    {id:2,path:'static/images/2.png'},
                    {id:3,path:'static/images/3.PNG'}
                ],
                swiperOption: {
                    notNextTick:true,
                    autoplay:3000,
