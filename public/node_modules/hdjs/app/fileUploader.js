        ...
        show: function (callback, options) {
            ...
            switch (options.type) {
                case 'image':
                    ...
                    <li role="presentation" class="active"><a href="#upload" aria-controls="home" role="tab" data-toggle="tab">画像アップロード</a></li>\
                    <li role="presentation"><a href="#imagelistsBox" aria-controls="profile" role="tab" data-toggle="tab">画像閲覧</a></li>\
                    </ul>',
                    ...
                    <div role="tabpanel" class="tab-pane active" id="upload"><div id="wrapper">\
                        ...
                        <div class="statusBar">\
                            ...
                            <div class="btn btn-primary uploadBtn">使用する</div>\
                ...
                ',
                        events: {
                            'shown.bs.modal': function () {
                                if (options.multiple) {
                                    $("#imagelistsBox").append('<br/><div class="text-right"><div class="btn btn-default" data-dismiss="modal">キャンセル</div> <div class="btn btn-primary uploadSelectFiles">使用確認</div></div>');
                                }
                                //加载远程文件
        ...
        initImageUploader: function (options) {
            ...
            function updateStatus() {
                ...
                if (state === 'ready') {
                    ...
                    text = '合計' + fileCount + '枚（' +
                        WebUploader.formatSize(fileSize) +
                        '），アップロード' + stats.successNum + '枚';

                    if (stats.uploadFailNum) {
                        text += '，失敗' + stats.uploadFailNum + '枚';
                    }
                }
