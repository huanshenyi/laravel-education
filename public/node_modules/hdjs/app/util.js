    ...
    util = {
        ...
        confirm: function (content, callback, options) {
            ...
            var modalobj = util.modal($.extend({
                title: 'システムメッセージ',
                content: content,
                footer: '<button type="button" class="btn btn-default" data-dismiss="modal">閉じる</button>' +
        ...
        ajaxShow: function (url, options) {
            ...
            //底部按钮
            opt.footer = (typeof opt.events['confirm'] == 'function' ? '<a href="#" class="btn btn-primary confirm">確認</a>' : '') + '<a href="#" class="btn cancel" data-dismiss="modal" aria-hidden="true">閉じる</a><iframe id="_formtarget" style="display:none;" name="_formtarget"></iframe>';
